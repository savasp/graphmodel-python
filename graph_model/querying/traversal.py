...
from typing import Generic, List, Optional, Protocol, Sequence, Type, TypeVar

from ..core.node import INode
from ..core.relationship import IRelationship

TStartNode = TypeVar('TStartNode', bound=INode, covariant=True)
TRelationship = TypeVar('TRelationship', bound=IRelationship, covariant=True)
TEndNode = TypeVar('TEndNode', bound=INode, covariant=True)
