...
class IGraphNodeQueryable(IGraphQueryable[N], Protocol[N]):
    ...
    def traverse(
        ...
        direction: GraphTraversalDirection | None = None
    ...
    def with_depth(self, min_depth: int, max_depth: int | None = None) -> IGraphNodeQueryable[N]:
        """
...
class QueryableBase(ABC, Generic[T]):
    ...
    def __init__(self, transaction: IGraphTransaction | None = None) -> None:
...
class GraphNodeQueryable(QueryableBase[N]):
    ...
    def traverse(
        ...
        traversal = TraversalStep(
            ...
            direction=direction or GraphTraversalDirection.OUTGOING
        )
        new_queryable._traversals.append(traversal)
        return new_queryable

    def with_depth(self, min_depth: int, max_depth: int | None = None) -> GraphNodeQueryable[N]:
